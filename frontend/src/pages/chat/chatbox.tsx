...
const ChatBox = () => {
  ...
  const { sendJsonMessage, lastJsonMessage, readyState } =
    useWebSocket<WebSocketEvent>(
      `ws://127.0.0.1:8090/ws/${room}?userName=Nico`,
      {
        share: true,
        retryOnError: true,
  ...
  return (
    <div className="bg-complement flex flex-col p-4 flex-1">
      <div className="overflow-scroll flex-1 basis-0" ref={boxRef}>
      ...
      <div className="flex pt-3">
        <div className="min-w-[108px] px-2 text-right text-xl">{"Nico"}</div>
        <div className="mx-1" />
        <div
          ref={inputRef}
          ...
          onKeyDown={(evt) =>
            evt.key === "Enter" && !evt.shiftKey && onSubmit()
          }
        />
